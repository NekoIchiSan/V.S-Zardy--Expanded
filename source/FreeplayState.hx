...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg = new FlxSprite(-80).loadGraphic(Paths.image('menuDesat', 'zardy'));
		...
		reanimatedCharactersBG = new FlxSprite(scoreText.x + 6, scoreText.y + 72).makeGraphic(1, 66, 0xFF000000);
	...
	private function positionHighscore() {
		...
		reanimatedCharactersBG.x = Std.int(scoreBG.x + (scoreBG.width / 2));
