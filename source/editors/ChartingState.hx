...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		else
		{
			...
			_song = {
				...
				speed: 1,
				stage: 'stage',
				songCreator: 'kawisprite',
				songCharter: 'ninjamuffin99',
				validScore: false
			};
			addSection();
	...
	function addSongUI():Void
	{
		...
		var songCharter = new FlxUIInputText(player2DropDown.x + 40, stageDropDown.y + 35, 100, _song.songCharter, 8, FlxColor.WHITE);
		blockPressWhileTypingOn.push(songCharter);

		var songCreator = new FlxUIInputText(player2DropDown.x + 40, stageDropDown.y + 50, 100, _song.songCreator, 8, FlxColor.WHITE);
		blockPressWhileTypingOn.push(songCreator);
		...
		tab_group_song.add(songCharter);
		tab_group_song.add(songCreator);
